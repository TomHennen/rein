"""sandbox_filesystem — the sandbox filesystem boundary, from INSIDE (#59/#63/#64).

See README.md for the full description; journey-authoring rules are in
tests/interactive/CLAUDE.md.

Code note: the agent is a deterministic bash script, NOT real claude — its phrasing must
be reproducible to be golden material. The real-claude contract read-back lives in
tests/interactive/test_agent_contract.py. The GitHub-WRITE twin is
journeys/write_ceremony/journey.py.
"""
